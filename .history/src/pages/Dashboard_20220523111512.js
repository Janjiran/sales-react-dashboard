              ...
              <div class="w-full bg-white rounded-xl overflow-hdden shadow-md p-4">
                ...
                <div class="p-4 undefined">
                  <div class="relative h-96">
                    ...
                    <iframe
                      src="https://secure.gooddata.com/dashboards/embedded/#/workspace/p39gouppdhiq5bpqrzufga8fqw8ykq2x/dashboard/abl9BkSm9CkY?showNavigation=false&setHeight=384"
                      height="384px"
                      width="100%"
                      frameborder="0"
                    />
            ...
            <div className="xl:col-start-4 xl:col-end-6 px-4 mb-14">
              <div class="w-full bg-white rounded-xl overflow-hdden shadow-md p-4">
                <div class="bg-gradient-to-tr from-pink-500 to-pink-700 -mt-10 mb-4 rounded-xl text-white grid items-center w-full h-24 py-4 px-8 justify-start shadow-lg-pink undefined">
                  ...
                  <h2 class="text-white text-2xl">Insight Embedding</h2>
                </div>
                <div class="p-4 undefined">
                  <div class="relative h-96">
                    <div class="chartjs-size-monitor">
                    ...
                    <InsightView insight="aeq8Q64q5AZv" />
                  </div>
                </div>
              </div>
              {/* <ChartBar /> */}
